...
export const REST_API = {
    TT: {
        START: `${ROOT}/${CONTROLLERS.TT_CONTROLLER}/${CONTROLLERS.TT_ROUTES.START}`,
        STOP: `${ROOT}/${CONTROLLERS.TT_CONTROLLER}/${CONTROLLERS.TT_ROUTES.STOP}`,
        STATUS: `${ROOT}/${CONTROLLERS.TT_CONTROLLER}/${CONTROLLERS.TT_ROUTES.STATUS}`,
        NODE_HEALTH_CHECK: `${ROOT}/${CONTROLLERS.TT_CONTROLLER}/${CONTROLLERS.TT_ROUTES.NODE_HEALTH_CHECK}`,
    },
    STATS: {
